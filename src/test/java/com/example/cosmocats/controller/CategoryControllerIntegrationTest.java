...
class CategoryControllerIntegrationTest extends AbstractIt {
  ...
  void createCategory_WithUserRole_ShouldReturnForbidden() {
    CategoryDto categoryDto = CategoryDto.builder().name("User Tried Category").build();
  ...
  void createCategory_WithoutAuthentication_ShouldReturnUnauthorized() {
    CategoryDto categoryDto = CategoryDto.builder().name("Unauthorized Category").build();
