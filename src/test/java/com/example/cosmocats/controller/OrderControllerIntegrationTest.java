...
class OrderControllerIntegrationTest extends AbstractIt {
    ...
    void createOrder_WithValidData_ShouldCreateOrder() {
        ...
        OrderEntryDto entry1 = OrderEntryDto.builder()
                .product(productDto1)
                .amount(2)
                .build();
    ...
    void createOrder_WithMultipleProducts_ShouldCreateOrder() {
        ...
        OrderEntryDto entry2 = OrderEntryDto.builder()
                .product(productDto2)
                .amount(3)
                .build();
    ...
    void createOrder_WithNonExistingProduct_ShouldReturnBadRequest() {
        ...
        OrderEntryDto entry = OrderEntryDto.builder()
                .product(invalidProductDto)
                .amount(1)
                .build();
    ...
    void getOrderById_WithExistingId_ShouldReturnOrder() {
        ...
        mockMvc.perform(get("/api/v1/orders/{id}", savedOrder.getOrderUuid())
    ...
    void getOrderById_WithNonExistingId_ShouldReturnNotFound() {
        ...
        mockMvc.perform(get("/api/v1/orders/{id}", nonExistingId)
                        .accept(MediaType.APPLICATION_JSON))
    ...
    void updateOrder_WithValidData_ShouldUpdateOrder() {
        ...
        mockMvc.perform(put("/api/v1/orders/{id}", savedOrder.getOrderUuid())
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateOrder_WithNonExistingId_ShouldReturnNotFound() {
        ...
        mockMvc.perform(put("/api/v1/orders/{id}", nonExistingId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(updateDto)))
                .andExpect(status().isNotFound());
    }
    ...
    void deleteOrder_WithExistingId_ShouldDeleteOrder() {
        ...
        mockMvc.perform(delete("/api/v1/orders/{id}", savedOrder.getOrderUuid()))
