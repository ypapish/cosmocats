...
public class CosmicWordValidator implements ConstraintValidator<CosmicWordCheck, String> {
    ...
    private static final List<String> COSMIC_TERMS = Arrays.asList(
        "galaxy", "star", "cosmic", "space", "nebula", "comet", 
        "orbit", "lunar", "solar", "asteroid", "planet", "meteor",
        "universe", "cosmos", "astro", "quantum", "interstellar",
        "black hole", "supernova", "constellation", "milky way"
    );
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        long cosmicWordCount = COSMIC_TERMS.stream()
            .filter(term -> containsWord(lowerCaseValue, term))
            .count();
