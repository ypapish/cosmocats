...
public class ProductService {
  ...
  public ProductDto createProduct(ProductUpdateDto createDto) {
    ...
    CategoryEntity category =
        categoryRepository
            .findByName(createDto.getCategory())
            .orElseThrow(
                () -> new RuntimeException("Category not found: " + createDto.getCategory()));
    ...
    log.info(
        "Product created successfully with ID: {} and UUID: {}",
        savedProduct.getProductId(),
        savedProduct.getProductUuid());
  ...
  public ProductDto updateProduct(UUID productUuid, ProductUpdateDto updateDto) {
    ...
    CategoryEntity category =
        categoryRepository
            .findByName(updateDto.getCategory())
            .orElseThrow(
                () -> new RuntimeException("Category not found: " + updateDto.getCategory()));
